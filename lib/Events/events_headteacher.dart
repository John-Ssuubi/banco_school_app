...
class UpcomingEventsPageHeadTeacher extends StatefulWidget {
  ...
  @override
  State<UpcomingEventsPageHeadTeacher> createState() => _UpcomingEventsPageState();
}

class _UpcomingEventsPageState extends State<UpcomingEventsPageHeadTeacher> {
  @override
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => AddEventsPage(schoolId: widget.schoolId),
              ),
            );
      }),
      body: StreamBuilder(
