...
class StatHtTermIII extends StatefulWidget {
  final String model;
  final String schoolId;
  const StatHtTermIII({super.key, required this.model, required this.schoolId});

  @override
  State<StatHtTermIII> createState() => _StatHtTermIIIState();
}

class _StatHtTermIIIState extends State<StatHtTermIII> {
  ...
  void _extractSubjects() async {
    ...
    try {
      ...
      if (snapshot.docs.isNotEmpty) {
        ...
        setState(() {
          subjects = student.subjectsScoreTerm3
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Statistics Term Three'),
        actions: [
            ...
            onSelected: (value) {
              if (value == "Term1") {
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        StatHt(model: widget.model, schoolId: widget.schoolId),
                  ),
                );
              }
          ...
          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              final List<Map<String, dynamic>> rankingsub =
                  getSubjectRankingBOTTerm3(students, selectedSubject ?? '');
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              // Subject Ranking Data Calculation
              final List<Map<String, dynamic>> rankingsub =
                  getSubjectRankingMIDTerm3(students, selectedSubject ?? '');
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              // Subject Ranking Data Calculation
              final List<Map<String, dynamic>> rankingsub =
                  getSubjectRankingENDTerm3(students, selectedSubject ?? '');
  ...
  List<GradeData> _calculateGradeDistribution(List<StudentModelP4> students) {
    ...
    for (var student in students) {
      if (student.subjectsScoreTerm3.isEmpty) continue;
