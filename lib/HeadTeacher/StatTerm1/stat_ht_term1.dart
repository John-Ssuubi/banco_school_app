...
class StatHtTermI extends StatefulWidget {
  ...
  const StatHtTermI({super.key, required this.model, required this.schoolId});
          ...
          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              final List<Map<String, dynamic>> rankingsub =
                  getSubjectRankingBOT(students, selectedSubject ?? '');
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              // Subject Ranking Data Calculation
              final List<Map<String, dynamic>> rankingsub =
                  getSubjectRankingMID(students, selectedSubject ?? '');
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              // Subject Ranking Data Calculation
              final List<Map<String, dynamic>> rankingsub =
                  getSubjectRankingEND(students, selectedSubject ?? '');
