...
class SubjectAnalysisTerm2 extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisTerm2({
    super.key,
  ...
  @override
  State<SubjectAnalysisTerm2> createState() => _SubjectAnalysisScreenState();
}

class _SubjectAnalysisScreenState extends State<SubjectAnalysisTerm2> {
