...
class SubjectAnalysisBotTerm2 extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisBotTerm2({
    super.key,
  ...
  @override
  State<SubjectAnalysisBotTerm2> createState() => _SubjectAnalysisBotScreenState();
}

class _SubjectAnalysisBotScreenState extends State<SubjectAnalysisBotTerm2> {
  ...
  Future<void> loadAnalysis() async {
    ...
    for (var doc in snapshot.docs) {
      ...
      List subjects = data["subjectsScoreTerm2"] ?? [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Subject Analysis BOT")),
...
class SubjectAnalysisMidTerm2 extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisMidTerm2({
    super.key,
    required this.schoolId,
    required this.model,
  });
  ...
  @override
  State<SubjectAnalysisMidTerm2> createState() => _SubjectAnalysisMidTerm2ScreenState();
}

class _SubjectAnalysisMidTerm2ScreenState extends State<SubjectAnalysisMidTerm2> {
  String currentYear = DateTime.now().year.toString();
  ...
  Future<void> loadAnalysis() async {
    ...
    for (var doc in snapshot.docs) {
      ...
      for (var subject in subjects) {
        ...
        double score = (subject["scoreMT"] ?? 0).toDouble();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Subject Analysis MID")),
...
class SubjectAnalysisEndTerm2 extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisEndTerm2({
    super.key,
    required this.schoolId,
    required this.model,
  });
  ...
  @override
  State<SubjectAnalysisEndTerm2> createState() => _SubjectAnalysisEndTerm2ScreenState();
}

class _SubjectAnalysisEndTerm2ScreenState extends State<SubjectAnalysisEndTerm2> {
  String currentYear = DateTime.now().year.toString();
  ...
  Future<void> loadAnalysis() async {
    ...
    for (var doc in snapshot.docs) {
      ...
      for (var subject in subjects) {
        ...
        double score = (subject["scoreEOT"] ?? 0).toDouble();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Subject Analysis End")),
