...
class SubjectContributionTerm2 extends StatefulWidget {
  final String schoolId;
  final String model;

  const SubjectContributionTerm2({
    super.key,
  ...
  @override
  State<SubjectContributionTerm2> createState() =>
      SubjectContributioneContributionState();
}

class SubjectContributioneContributionState
    extends State<SubjectContributionTerm2> {
