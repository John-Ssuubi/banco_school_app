...
class SubjectContributionBotTerm2 extends StatefulWidget {
  final String schoolId;
  final String model;

  const SubjectContributionBotTerm2({
    super.key,
  ...
  @override
  State<SubjectContributionBotTerm2> createState() =>
      SubjectContributionBotTerm2State();
}

class SubjectContributionBotTerm2State
    extends State<SubjectContributionBotTerm2> {
...
class SubjectContributionMidTerm2 extends StatefulWidget {
  final String schoolId;
  final String model;

  const SubjectContributionMidTerm2({
    super.key,
    required this.schoolId,
    required this.model,
  });
  ...
  @override
  State<SubjectContributionMidTerm2> createState() =>
      SubjectContributionMidTerm2State();
}

class SubjectContributionMidTerm2State
    extends State<SubjectContributionMidTerm2> {
  String currentYear = DateTime.now().year.toString();
...
class SubjectContributionEndTerm2 extends StatefulWidget {
  final String schoolId;
  final String model;

  const SubjectContributionEndTerm2({
    super.key,
    required this.schoolId,
    required this.model,
  });
  ...
  @override
  State<SubjectContributionEndTerm2> createState() =>
      SubjectContributionEndTerm2EndState();
}

class SubjectContributionEndTerm2EndState
    extends State<SubjectContributionEndTerm2> {
  String currentYear = DateTime.now().year.toString();
