...
import 'package:banco_mobile/HeadTeacher/AssessmentTerm2/TermSectionsTerm2.dart';
...
void showStudentSummaryDialog(
  ...
  int total = totalBOT(student.subjectsScoreTerm2).toInt();
  int average = averageScore(student.subjectsScoreTerm2).toInt();
  int aggregate = totalAggregate(student.subjectsScoreTerm2);
