...
class SubjectAnalysisBot extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisBot({
    super.key,
  ...
  @override
  State<SubjectAnalysisBot> createState() => _SubjectAnalysisBotScreenState();
}

class _SubjectAnalysisBotScreenState extends State<SubjectAnalysisBot> {
...
class SubjectAnalysisMid extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisMid({
    super.key,
    required this.schoolId,
    required this.model,
  });
  ...
  @override
  State<SubjectAnalysisMid> createState() => _SubjectAnalysisMidScreenState();
}

class _SubjectAnalysisMidScreenState extends State<SubjectAnalysisMid> {
  String currentYear = DateTime.now().year.toString();
...
class SubjectAnalysisEnd extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisEnd({
    super.key,
    required this.schoolId,
    required this.model,
  });
  ...
  @override
  State<SubjectAnalysisEnd> createState() => _SubjectAnalysisEndScreenState();
}

class _SubjectAnalysisEndScreenState extends State<SubjectAnalysisEnd> {
  String currentYear = DateTime.now().year.toString();
