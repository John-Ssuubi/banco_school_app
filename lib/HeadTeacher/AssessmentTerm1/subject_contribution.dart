...
class SubjectContributionBot extends StatefulWidget {
  final String schoolId;
  final String model;

  const SubjectContributionBot({
    super.key,
  ...
  @override
  State<SubjectContributionBot> createState() =>
      SubjectContributionBotState();
}

class SubjectContributionBotState
    extends State<SubjectContributionBot> {
...
class SubjectContributionMid extends StatefulWidget {
  final String schoolId;
  final String model;

  const SubjectContributionMid({
    super.key,
    required this.schoolId,
    required this.model,
  });
  ...
  @override
  State<SubjectContributionMid> createState() =>
      SubjectContributionMidState();
}

class SubjectContributionMidState
    extends State<SubjectContributionMid> {
  String currentYear = DateTime.now().year.toString();
...
class SubjectContributionEnd extends StatefulWidget {
  final String schoolId;
  final String model;

  const SubjectContributionEnd({
    super.key,
    required this.schoolId,
    required this.model,
  });
  ...
  @override
  State<SubjectContributionEnd> createState() =>
      SubjectContributionEndEndState();
}

class SubjectContributionEndEndState
    extends State<SubjectContributionEnd> {
  String currentYear = DateTime.now().year.toString();
