...
class SubjectAnalysisBotTerm3 extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisBotTerm3({
    super.key,
  ...
  @override
  State<SubjectAnalysisBotTerm3> createState() => _SubjectAnalysisBotScreenState();
}

class _SubjectAnalysisBotScreenState extends State<SubjectAnalysisBotTerm3> {
...
class SubjectAnalysisMidTerm3 extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisMidTerm3({
    super.key,
    required this.schoolId,
    required this.model,
  });
  ...
  @override
  State<SubjectAnalysisMidTerm3> createState() => _SubjectAnalysisMidTerm3ScreenState();
}

class _SubjectAnalysisMidTerm3ScreenState extends State<SubjectAnalysisMidTerm3> {
  String currentYear = DateTime.now().year.toString();
...
class SubjectAnalysisEndTerm3 extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisEndTerm3({
    super.key,
    required this.schoolId,
    required this.model,
  });
  ...
  @override
  State<SubjectAnalysisEndTerm3> createState() => _SubjectAnalysisEndTerm3ScreenState();
}

class _SubjectAnalysisEndTerm3ScreenState extends State<SubjectAnalysisEndTerm3> {
  String currentYear = DateTime.now().year.toString();
