...
class SubjectAnalysisTerm3 extends StatefulWidget {
  final String schoolId;
  final String model; // e.g P4

  const SubjectAnalysisTerm3({
    super.key,
  ...
  @override
  State<SubjectAnalysisTerm3> createState() => _SubjectAnalysisScreenState();
}

class _SubjectAnalysisScreenState extends State<SubjectAnalysisTerm3> {
