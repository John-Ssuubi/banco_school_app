...
class ClassAssessmentTerm3 extends StatefulWidget {
  ...
  @override
  State<ClassAssessmentTerm3> createState() => _ClassAssessmentTerm2State();
}

class _ClassAssessmentTerm2State extends State<ClassAssessmentTerm3> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: isSearching
            ...
            : Text('Class Assessment Term III', style: whiteText),
            ...
            child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                filteredStudents.sort(
                  (a, b) => totalAggregate(
                    a.subjectsScoreTerm3,
                  ).compareTo(totalAggregate(b.subjectsScoreTerm3)),
                );
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Agg: ${totalAggregate(student.subjectsScoreTerm3)}   |   "
                              "Div: ${getDivision(totalAggregate(student.subjectsScoreTerm3))}",
                              style: const TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.w500,
                              ),
                  ...
                  FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) {
                            return SubjectContributionTerm3(
                              schoolId: widget.schoolId,
                              model: widget.model,
                            );
                          },
