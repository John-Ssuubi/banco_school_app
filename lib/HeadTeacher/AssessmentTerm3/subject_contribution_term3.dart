...
class SubjectContributionTerm3 extends StatefulWidget {
  final String schoolId;
  final String model;

  const SubjectContributionTerm3({
    super.key,
  ...
  @override
  State<SubjectContributionTerm3> createState() =>
      SubjectContributioneContributionState();
}

class SubjectContributioneContributionState
    extends State<SubjectContributionTerm3> {
