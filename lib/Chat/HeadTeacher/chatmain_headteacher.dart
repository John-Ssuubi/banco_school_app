...
class ChatmainHeadteacher extends StatefulWidget {
  final String schoolId;
  final String parentId;
  final String myRole;

  const ChatmainHeadteacher({
    super.key,
  ...
  @override
  State<ChatmainHeadteacher> createState() => _ChatmainHeadteacherState();
}

class _ChatmainHeadteacherState extends State<ChatmainHeadteacher> {
  ...
  Future<void> _initChat() async {
    final id = await getOrCreateChatIdHeadTeacher(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 230, 217, 217),
      appBar: AppBar(
         leading: InkWell(
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isMe ? Colors.grey : Colors.grey.shade300,
