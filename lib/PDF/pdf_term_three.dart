...
class ReportCardPdfTermIII {static Future<void> generate({
          ...
          children: [
            ...
            pw.Table(
              ...
              children: [
                ...
                // Data Rows
                ...student.subjectsScoreTerm3.map(
                  (s) => pw.TableRow(
                    children: [
                      _cell(s.subjectName),
                      _cell("${s.scoreEOT}"),
            ...
            pw.Container(
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    "TERM AGGREGATE: ${gradeEotTerm3(student.subjectsScoreTerm3, d1Start, d2Start, c3Start, c4Start, c5Start, c6Start, p7Start, p8Start, f9Start, f9End)}",
                    style: pw.TextStyle(
                      fontWeight: pw.FontWeight.bold,
                    ),
                  ),
                  pw.Text(
                    "DIVISION: ${gradeEotTerm3(student.subjectsScoreTerm3, d1Start, d2Start, c3Start, c4Start, c5Start, c6Start, p7Start, p8Start, f9Start, f9End)}",
                    style: pw.TextStyle(
                      fontWeight: pw.FontWeight.bold,
                    ),
                  ),
