import 'package:banco_mobile/Auth/admin_form.dart';
...
class _CreatState extends State<CreateAccountAdmin> {
        ...
        child: ListView(
          ...
          children: [
            Column(
              children: [
                Text(
                  'Create Account', // Note: Title says 'LogIn' but widget is 'CreateAccountAdmin'
                  style: TextStyle(
                    color: mainColor,
                    fontSize: largefonts,
                    fontWeight: FontWeight.bold,
