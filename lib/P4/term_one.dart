...
class _TermOneState extends State<TermOne> {
  ...
  /// Shows the student's profile picture when available, falling back to
  /// a generic person icon otherwise. NetworkImage is safe cross-platform
  /// (web + mobile) since it fetches a URL rather than touching dart:io.
  /// [imageUrl] is read directly from the raw Firestore document (the
  /// 'image' field isn't part of StudentModelP4), not from the model.
                        ...
                        StreamBuilder<DocumentSnapshot>(
                          ...
                          builder: (context, asyncSnapshot) {
                            ...
                            return IconButton(
                              ...
                              onPressed: () async {
                                // ─── UPDATED: Pass imageUrl to PDF generator ───
