...
class ParentChildResultsTerm2 extends StatefulWidget {
    final String schoolId;
  Stream<QuerySnapshot<Map<String, dynamic>>> snp;
  ParentChildResultsTerm2({required this.snp, super.key, required this.schoolId});

  @override
  State<ParentChildResultsTerm2> createState() => _ParentsChildProfileState();
}

class _ParentsChildProfileState extends State<ParentChildResultsTerm2> {
